...
watch(daysInCalendar, (days) => {
  emit('changeInterval', {
    start: days[0].timestamp,
    end: days[days.length - 1].timestamp
  })
}, {
  immediate: true,
  flush: 'post'
  ...
  <div class="icg">
    ...
    <div class="icg-weekdays">
      <div
        ...
        :key="weekday"
        class="icg-weekdays-cell"
        :class="{ 'icg-weekdays-cell--weekend': i === (props.firstDayOfWeek ? 5 : 0) || i === 6 }"
      >
        {{ weekday }}
      </div>
    </div>
